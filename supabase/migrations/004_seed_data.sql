-- Sobana Hotel seed — valid UUIDs only
...
DELETE FROM restaurants WHERE slug = 'sobana-hotel';
...
INSERT INTO restaurants (
  ...
  'info@sobanahotel.et',
  'Arba Minch, Ethiopia',
  'Thank you for visiting Sobana Hotel — enjoy every meal.',
...
INSERT INTO menu_items (category_id, restaurant_id, name, description, price, availability, display_order) VALUES
  ...
  ('c1000000-0000-0000-0000-00000000000a', 'b0000000-0000-0000-0000-000000000001', 'Sobana Special Burger', NULL, 750, 'available', 1),
